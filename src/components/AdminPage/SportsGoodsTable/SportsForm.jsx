...
import Services from "../../../services/sportbuyum";
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          {data.id ?
          "Sport buyumlari sahifasi ma'lumotini yangilash" :
          "Sport buyumlari sahifasiga yangi malumot qo'shish"
        }
        </Typography>
